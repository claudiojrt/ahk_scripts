pref_preferences(){
    ...
    fpar := ini_getPropriety("FormatParameter")
    ...
    IfWinExist, Preferences
	{
        ...
        Gui, New, , Preferences
        Gui, Add, GroupBox, x12 y6 w400 h186,
        ...
        Gui, Add, Checkbox, x24 y162 w300 h24 vpref_fpar checked%fpar%, Enable "Format Parameter" (F2)
        Gui, Add, Button, x317 y202 w96 h24 gpref_Button1, Ok
        Gui, Show, w425 h235,
        return
	}
	return
...
pref_Button1:
{
    ...
    if (pref_sqcl != "") {
        ...
        ini_setPropriety("FormatParameter",pref_fpar)
    }
    return
}